...
import { ShoppingBag, Search, Menu, UserCircle, LogOut, ChevronDown } from 'lucide-react';
            ...
            {user ? (
              <div className="relative">
                ...
                >
                  ...
                  <span className="text-sm font-bold hidden lg:block italic tracking-tight">{user.username}</span>
              ...
              >
                ...
                <span className="text-sm font-black uppercase tracking-widest hidden lg:block">Sign In</span>
              </Link>
            )}
