    ...
    <div style={{ height: height }} className="w-full">
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          />
          <Area type="monotone" dataKey={dataKey1} stroke={color1} strokeWidth={2} fillOpacity={1} fill={`url(#color-${dataKey1})`} name={dataKey1} />
          {dataKey2 && (
             <Area type="monotone" dataKey={dataKey2} stroke={color2} strokeWidth={2} fillOpacity={1} fill={`url(#color-${dataKey2})`} name={dataKey2} />
          )}
        </AreaChart>
      </ResponsiveContainer>
    </div>
