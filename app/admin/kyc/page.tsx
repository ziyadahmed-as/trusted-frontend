...
export default function KYCManagementPage() {
  ...
  const fetchStats = useCallback(async () => {
    try {
      console.log('[KYC Management] Fetching stats from:', apiClient.getCurrentApiUrl());
  ...
  const handleDocumentAction = async (recordId: string, action: 'approve' | 'reject') => {
                                   ...
                                   {rejectId === record.id ? (
                                     ...
                                     <>
                                       ...
                                       <button 
                                         ...
                                         className="w-full py-3 bg-white border border-rose-100 text-rose-600 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-rose-50 transition-all flex items-center justify-center gap-2"
                                       >
                                         <UserX className="w-4 h-4" /> Reject Evidence
                                       </button>
                                     </>
                                   )}
                                 </>
