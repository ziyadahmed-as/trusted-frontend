                  ...
                  >
                    ...
                    <td className="py-6 px-10">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button title="Edit User" onClick={() => openEditModal(user)} className="p-3 bg-white text-gray-400 hover:text-indigo-600 hover:shadow-lg rounded-xl transition-all border border-gray-100">
                          <Edit className="w-4 h-4" />
                        </button>
                        <button title="Delete User" onClick={() => handleDelete(user.id, user.username)} className="p-3 bg-white text-gray-400 hover:text-rose-600 hover:shadow-lg rounded-xl transition-all border border-gray-100">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            >
              <div className="p-10 border-b border-gray-50 flex items-center justify-between">
                ...
                <button title="close modal" onClick={() => { setShowEditModal(false); setShowAddModal(false); }} className="p-3 bg-gray-50 text-gray-400 hover:text-rose-500 rounded-2xl transition-colors">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
            ...
            >
              <div className="p-10 border-b border-gray-50 flex items-center justify-between">
                ...
                <button title="Close" onClick={() => setShowPasswordModal(false)} className="p-3 bg-gray-50 text-gray-400 hover:text-rose-500 rounded-2xl transition-colors">
                  <XCircle className="w-6 h-6" />
                </button>
              </div>
              ...
              <div className="p-10">
                <form onSubmit={handlePasswordChange} className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <input title='Confirm Security Key'
                      type="password"
                      required
