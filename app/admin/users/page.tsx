      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="text-sm font-medium text-[#64748b]">
            Manage the platform directory, roles, and access control.
          </p>
        </div>
        <button
            ...
            <tbody>
              {filteredUsers.length === 0 && !loading ? (
                ...
                filteredUsers.map((user) => (
                  <tr
                    key={user.id}
                    className="border-b border-[#e2e8f0] last:border-0 hover:bg-[#f9fafb] transition"
                  >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-lg rounded-sm border border-[#e2e8f0] bg-white shadow-default">
            ...
            <form
              ...
              className="p-6.5 max-h-[80vh] overflow-y-auto"
            >
              <div className="mb-4.5 flex gap-4">
                <div className="w-1/2">
                  <label className="mb-2.5 block text-sm font-medium text-black">
